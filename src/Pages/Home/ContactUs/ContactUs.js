...
const ContactUs = () => {
    ...
    return (
        <section className="hero mt-16 p-2" style={{
            ...
            <div className='text-center'>
                ...
                <h1 className='text-white font-bold text-4xl'>Stay with us</h1>
            <div className="hero-content flex-col lg:flex-row gap-16 my-5">
                <div className='rounded-xl lg:w-1/2'data-aos="flip-left">
                    <iframe className='map' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29073.83467664921!2d91.38732527780857!3d24.373324226682062!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x375144f6464c0833%3A0xb6a116d243e411d2!2z4KaG4Kan4KeB4Kao4Ka_4KaVIOCmnOCnh-CmsuCmviDgprjgpqbgprAg4Ka54Ka-4Ka44Kaq4Ka-4Kak4Ka-4KayLCDgprngpqzgpr_gppfgpp7gp43gppw!5e0!3m2!1sen!2sbd!4v1686234041758!5m2!1sen!2sbd" width="230" height="300" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
